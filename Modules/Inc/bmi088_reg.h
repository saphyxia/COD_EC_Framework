...
/**
  ******************************************************************************
  * @file           : bmi088_reg.h
  * @brief          : Header for bmi088 register values.
  * 
  ******************************************************************************
  * @attention      : none
  *
...
#define BMI088_ACC_CONF 0x40    /*!< accelerator configuage register */
...
/**
 * @brief Interrupts are mapped to INT1 and INT2. 
 *
 */
...
/**
 * @brief accelerator switch into suspend mode, when data collection stop.
 */
...
/**
 * @brief Turn on/off the accelerator.
 */
...
#define BMI088_GYRO_RANGE 0x0F  /*!< rate range and resolution */
...
#define BMI088_GYRO_SOFTRESET_VALUE 0xB6  /*!< transmit 0xB6 to reset */

#define BMI088_GYRO_CTRL 0x15   /*!< Data Interrupt Trigger address */
#define BMI088_DRDY_OFF 0x00    /*!< No data ready for interrupt trigger */
#define BMI088_DRDY_ON 0x80     /*!< Allow new data to trigger the interrupt */
